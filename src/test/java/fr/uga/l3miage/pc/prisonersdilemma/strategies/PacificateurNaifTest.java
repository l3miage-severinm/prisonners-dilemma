...
public class PacificateurNaifTest {
    ...
    private final SimpleStrategy STRATEGIE = FabriqueStrategie.getInstance().createStrategie(EnumStrategie.PACIFICATEUR_NAIF);
    ...
    void doitTrahir(){
        ...
        final double PROBABILITE_COOPERER = 0.3;
